...
import { FaUserEdit, FaSave, FaCamera, FaExternalLinkAlt, FaHandHoldingHeart } from "react-icons/fa";
            ...
            <div className="bg-white/90 rounded-3xl p-8">
                ...
                <div className="flex flex-col items-center mb-8">
                    ...
                    <h2 className="text-2xl md:text-3xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-pink-600 to-blue-500 mt-3">
                        Edit Service’s Details
                    </h2>
                    <p className="text-gray-500 text-center mt-1">
                        Update service’s image, title & description
                    </p>
                </div>
                ...
                {services.map(service => (
                    ...
                    >
                        <img
                            src={service.url}
                            alt={service.name}
                            className="w-15 object-cover rounded-2xl shadow-md"
                        />
                            ...
                            <button
                                ...
                                onClick={async () => {
                                    try {
                                        ...
                                        refetch();
                                        Swal.fire("Deleted!", `${service.name} deleted.`, "success");
